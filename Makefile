...
SOURCES += squirrel/squirrel/sqapi.cpp
SOURCES += squirrel/squirrel/sqclass.cpp
SOURCES += squirrel/squirrel/sqdebug.cpp
SOURCES += squirrel/squirrel/sqlexer.cpp
SOURCES += squirrel/squirrel/sqobject.cpp
SOURCES += squirrel/squirrel/sqtable.cpp
SOURCES += squirrel/squirrel/sqbaselib.cpp
SOURCES += squirrel/squirrel/sqcompiler.cpp
SOURCES += squirrel/squirrel/sqfuncstate.cpp
SOURCES += squirrel/squirrel/sqmem.cpp
SOURCES += squirrel/squirrel/sqstate.cpp
SOURCES += squirrel/squirrel/sqvm.cpp
