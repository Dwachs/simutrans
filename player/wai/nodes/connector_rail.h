#ifndef CONNECTOR_RAIL_H
#define CONNECTOR_RAIL_H

/*
 * This node builds a rail connection.
 */
...
class connector_rail_t : public bt_sequential_t
{
public:
	connector_rail_t( ai_wai_t *sp, const char *name);
	/**
	 * the constructor
	 ...
	 * @param rail_besch: rail type to be built
	 * @param d, nr_vehicles: passed to vehicle_builder
	 */
	connector_rail_t( ai_wai_t *sp, const char *name, const fabrik_t *fab1, const fabrik_t *fab2, koord3d start_, koord3d ziel_, const weg_besch_t *rail_besch, simple_prototype_designer_t *d, uint16 nr_veh);
	~connector_rail_t();
